...
const Sidebar = (props: Props) => {
    ...
    return (
        <div className='max-w-[300px] bg-[#ffffff] h-[100vh] max-h-[100vh] w-[300px] border-x-[1px] border-[#e5e5e5]'>
            <div className='px-[24px] py-[30px] flex items-center '>
                ...
                <div className='pl-[10px] b-r'>
                    <p className='text-black text-[22px] font-medium'>Mrinal Tewary...</p>
